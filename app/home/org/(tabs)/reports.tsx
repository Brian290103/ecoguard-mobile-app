...
import { getOrganizationId, getAssignedReports } from "@/lib/orgReports";
...
export default function Reports() {
  ...
  const fetchReports = async () => {
    try {
      ...
      const data = await getAssignedReports(organizationId);
  ...
  if (loading) {
    return (
      <SafeAreaView style={styles.container}>
        <Stack.Screen options={{ title: "Assinged Reports" }} />
